...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($cliente['nome'] === '' || $cliente['cpf'] === '') {
        ...
        try {
            $cliente['foto_perfil'] = salvarFotoCliente($_FILES['foto_perfil'] ?? []);
            ...
            header("Location: clientes.php?sucesso=cadastrar");
            exit;
        } catch (RuntimeException $e) {
            $erro = $e->getMessage();
        } catch (PDOException $e) {
            $erro = 'Nao foi possivel cadastrar o cliente. Verifique se o CPF ja esta cadastrado.';
        }
    }
}
?>
...
<head>
    ...
    <title>PetLife - Cadastrar Cliente</title>
...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mb-1">Cadastrar cliente</h1>
            <p class="text-muted mb-0">Novo tutor no sistema</p>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="form-text">Formatos aceitos: JPG, PNG ou WEBP. Tamanho maximo: 2 MB.</div>
                    </div>
                    <div class="col-md-6">
