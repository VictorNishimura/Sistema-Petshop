...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: agendamentos.php?data=" . date('Y-m-d', strtotime($agendamento['data_hora'])) . "&sucesso=excluir");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>PetLife - Excluir Agendamento</title>
...
<div class="container mt-5">
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <h1 class="mb-3">Excluir agendamento cancelado</h1>
            <p>Tem certeza que deseja excluir o agendamento cancelado de <strong><?php echo htmlspecialchars($agendamento['pet_nome']); ?></strong>?</p>
